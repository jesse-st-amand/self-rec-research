...
# ============================================================================
# Run F1 version if aggregated_f1.csv exists (IND experiments only)
# ============================================================================

F1_FILE="$LATEST_DIR/aggregated_f1.csv"
if [[ -f "$F1_FILE" ]]; then
    echo ""
    echo "=============================================================================="
    echo "Running F1 Score version"
    echo "=============================================================================="
    uv run "$ENTRY_POINT" \
            --aggregated_file "$F1_FILE" \
            --model_names "${MODEL_NAMES[@]}"
fi
