...
ICA_DIR="experiments_eval/ICA/SGTR_07_trained-OP-ShareGPT_eval-on_self-same-OP-WikiSum_ICA-ShareGPT/qwen-3.0-30b"
...
echo "SGTR_07_trained-OP-ShareGPT_eval-on_self-same-OP-WikiSum_ICA-ShareGPT/qwen-3.0-30b complete."
