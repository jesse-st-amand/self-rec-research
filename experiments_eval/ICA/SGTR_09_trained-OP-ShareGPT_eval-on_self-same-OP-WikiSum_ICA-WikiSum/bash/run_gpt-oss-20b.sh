...
ICA_DIR="experiments_eval/ICA/SGTR_09_trained-OP-ShareGPT_eval-on_self-same-OP-WikiSum_ICA-WikiSum/gpt-oss-20b"
...
echo "SGTR_09_trained-OP-ShareGPT_eval-on_self-same-OP-WikiSum_ICA-WikiSum/gpt-oss-20b complete."
